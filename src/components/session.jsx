    ...
    render() {
        return (
            <ResponsiveContainer width="100%" height="100%">
                <LineChart width={200} height={200} margin={{ top: 0, right: 10, bottom: 0, left: 10 }} data={this.props.sessions}>
